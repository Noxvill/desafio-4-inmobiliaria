...
const propiedades_venta = [
...

  {
    ...
    descripcion: "Cómoda y acogedora cabaña en medio del bosque, cuenta con comodidades básicas para disfrutar de un hermoso tiempo de desconexión",
...
"</p>"+"<i class='fas fa-map-marker-alt'>"+"</i>"+"<p>"+propiedades_venta.ubicacion+"</p>"+
"<p>"+"<i class='fas fa-bed'>"+"</i>"+" "+propiedades_venta.habitaciones+ " "+ "habitaciones"+" "+"|"+" "+"<i class='fas fa-bath'>"+"</i>" +" "+propiedades_venta.baños+ " "+ "baños"+ "</p>"+

"<p>"+"<i class='fas fa-dollar-sign'>"+"</i>"+propiedades_venta.costo+
"</p>"+

"<p class='text-danger'>"+"<i class='fas fa-smoking-ban'>"+"</i>"+" "+ "No se permite fumar"+ "</p>"+
"<p class='text-danger'>"+"<i class='fa-solid fa-ban'>"+"</i>"+" "+propiedades_venta.pets+"</p>"
